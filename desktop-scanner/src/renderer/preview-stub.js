...
(function () {
  ...
  var SAMPLE_SCANS = [
    ...
    { name: 'Mark Anthony Villamor', personType: 'student', category: '',            gradeLevel: 'Grade 4',  sectionName: 'Narra',       schoolName: 'Agripino Elementary School',      scanTime: new Date().toISOString(), eventAction: 'TIME_IN',  attendanceStatus: 'half_day', displayStatus: 'PM LATE' },
    ...
    { name: 'Grace Padayhag',        personType: 'student', category: '',            gradeLevel: 'Grade 5',  sectionName: 'Mango',       schoolName: 'Agripino Elementary School',      scanTime: new Date().toISOString(), eventAction: 'TIME_OUT', attendanceStatus: 'half_day', displayStatus: 'OUT' },
