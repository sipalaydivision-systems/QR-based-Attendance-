...
(function () {
  ...
  var DEMO_ACTIONS = [
    ...
    function () {
      return Object.assign({}, BASE_STATUS, { success: true, action: 'TIME_OUT', status: 'half_day', attendance_status: 'Half-Day PM Early Out', half_day_type: 'pm_early_out', remarks: 'Early Out During PM Session', display_status: 'EARLY OUT', message: 'Half-Day PM Early Out recorded.', person: SHS_TEACHER, time: _time(), time_in: '07:20 AM', time_out: '02:00 PM' });
    },
    function () {
