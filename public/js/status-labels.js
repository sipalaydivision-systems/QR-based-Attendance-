(function (global) {
    var STATUS_LABELS = {
        ...
        half_day: 'Half-Day',
        'half day': 'Half-Day',
        // Legacy: returns from lunch were previously labelled "WELCOME BACK".
        // Render as "PM Time In" so historical rows match the current policy.
        'welcome back': 'PM Time In',
        welcome_back: 'PM Time In',
        'pm time in': 'PM Time In',
        pm_time_in: 'PM Time In',
        'pm late time in': 'PM Late Time In',
        pm_late_time_in: 'PM Late Time In',
        'time in': 'Time In',
        time_in: 'Time In',
        'late time in': 'Late Time In',
        ...
        half_day_am_early_dismissal: 'Early Dismissal (AM)',
        'half day am early dismissal': 'Early Dismissal (AM)',
        half_day_pm_early_dismissal: 'Early Dismissal (PM)',
        'half day pm early dismissal': 'Early Dismissal (PM)',
